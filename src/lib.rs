...
use pyo3::{wrap_pyfunction, FromPyObject, IntoPyObject, PyObject};
use schnorrkel::MiniSecretKey;
// TODO: Use this keypair type
...
#[pymodule]
fn schnorpy(_py: Python, m: &PyModule) -> PyResult<()> {
